...
with DAG(
    ...
    generate_daily_cimb_report = PythonOperator(
        task_id="generate_daily_cimb_report",
        python_callable=generate_daily_cimb_report,
    ...
    send_email = PythonOperator(
        ...
        op_kwargs={"task_id": "generate_daily_cimb_report"},
    )

    (initial_node >> generate_daily_cimb_report >> send_email)
